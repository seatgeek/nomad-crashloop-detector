...
BINARIES = $(addprefix $(BUILD_DIR)/nomad-crashloop-detector-, $(GOBUILD))
$(BINARIES): $(BUILD_DIR)/nomad-crashloop-detector-%: $(BUILD_DIR)
	@echo "=> building $@ ..."
...
docker:
	...
	docker build -f Dockerfile -t seatgeek/nomad-crashloop-detector:$(COMMIT) .
	docker tag seatgeek/nomad-crashloop-detector:$(COMMIT) seatgeek/nomad-crashloop-detector:$(TAG)
	docker push seatgeek/nomad-crashloop-detector:$(TAG)
